...
keymap.set("n", "<C-]>", ":vertical resize -10<CR>", {desc = "Reduce size of split vertically."})
keymap.set("n", "<C-[>", ":vertical resize +10<CR>", {desc = "Expand size of split vertically."})
-- TODO: idk shortcuts
-- keymap.set("n", "<C-=>", ":resize -10<CR>", {desc = "Reduce size of split horizontally."})
-- keymap.set("n", "<C-}>", ":resize +10<CR>", {desc = "Expand size of split horizontally."})
